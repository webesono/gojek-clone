    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form  method="POST" action="{{ url('/dashboard/allcategories') }}" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
    ...
    <div class="table-responsive col-lg-5" style="font-size: 15px">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{ url('/dashboard/allcategories')}}/{{ $category->id }}/edit" class="badge bg-warning"><span data-feather="edit"></span></a>
                <form  class="d-inline" action="{{ url('/dashboard/allcategories')}}/{{ $category->id }}" method="POST" col-lg-11>
                  @method('delete')
                  @csrf
